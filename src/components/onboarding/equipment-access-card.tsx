...
import type { EquipmentAccessOption } from '@/data/onboarding/equipment-access';
import { onboardingLayout, onboardingTheme } from '@/data/onboarding/theme';

const AnimatedPressable = Animated.createAnimatedComponent(Pressable);

interface EquipmentAccessCardProps {
  option: EquipmentAccessOption;
  selected: boolean;
  onPress: () => void;
}

export function EquipmentAccessCard({ option, selected, onPress }: EquipmentAccessCardProps) {
